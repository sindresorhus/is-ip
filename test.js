...
test('isIPv6', t => {
	...
	t.false(isIPv6('2001:0dc5:72a3:0000:0000:802e:3370:73E4XXXXXXXX'));
});

test('isIPv4', t => {
	t.true(isIPv4('192.168.0.1'));
	t.false(isIPv4('123.123.123.1234'));
	t.false(isIPv4('123.123.123.12345'));
});
...
test('ipVersion', t => {
	...
	t.is(ipVersion('123.123.123.12345'), undefined);
});
